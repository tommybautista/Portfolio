...
from flask_app.models.tripPlanner.user import User
from flask_app.models.tripPlanner.event import Event
...
def indexTripPlanner():
    if 'user_id' in session:
        ...
        return render_template('/tripPlanner/dashboardTripPlanner.html', user = User.get_user_by_id(user_data), events = Event.get_events_by_user(user_data))
    return render_template('/tripPlanner/indexTripPlanner.html')


@app.route('/login')
def login():
    return render_template("/tripPlanner/login.html", title='Login')

@app.route('/register')
def register():
    return render_template("/tripPlanner/registration.html", title='Register')    
...
def account(id):
    ...
    print(id)
    return render_template('/tripPlanner/account.html', user = User.get_user_by_id(data))
...
def update_user(id):
    ...
    print(id)
    return render_template('/tripPlanner/user_update.html',user = User.get_user_by_id(data))
